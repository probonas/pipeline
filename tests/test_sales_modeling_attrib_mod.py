...
class PIRModelingTest_AttributionModifiers(TestSalesPipelineOutput):
	def test_modeling_for_attribution_modifiers(self):
		...
		people = attr_assignment2['assigned']['carried_out_by']
		self.assertEqual(len(people), 1)
		self.assertEqual(people[0]['_label'], 'Gosdaert [?]')
		...
		people = attr_assignment1['assigned']['carried_out_by']
		self.assertEqual(len(people), 1)
		self.assertEqual(people[0]['_label'], 'SAVERY (XAVERY)')
